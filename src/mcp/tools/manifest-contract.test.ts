...
const EXPECTED_PACKS: Record<string, string> = {
  ...
  get_cloudwatch_logs: "observability",
  get_cloudwatch_alarm_summary: "observability",
  get_recent_log_errors: "observability",
  list_lambda_functions: "inventory",
  list_s3_buckets: "inventory",
  list_log_groups: "observability",
  get_ecs_service_health: "observability",
  list_ecs_tasks: "observability",
  ...
  get_ecr_image_status: "inventory",
  compare_ecs_task_image_with_ecr: "inventory",
  get_s3_bucket_posture: "security",
  get_ses_configuration_status: "security",
  get_sns_topic_status: "observability",
  get_eventbridge_rules_status: "observability",
  get_budget_status: "cost",
...
const EXPECTED_CATALOG_ANCHORS = [
  ...
  { toolName: "get_ecs_service_health", docsAnchor: "13-get_ecs_service_health" },
  { toolName: "list_ecs_tasks", docsAnchor: "14-list_ecs_tasks" },
  { toolName: "get_recent_stopped_ecs_tasks", docsAnchor: "15-get_recent_stopped_ecs_tasks" },
  { toolName: "get_cloudwatch_logs", docsAnchor: "16-get_cloudwatch_logs" },
  ...
  { toolName: "get_ecr_image_status", docsAnchor: "21-get_ecr_image_status" },
  { toolName: "compare_ecs_task_image_with_ecr", docsAnchor: "22-compare_ecs_task_image_with_ecr" },
  { toolName: "get_s3_bucket_posture", docsAnchor: "23-get_s3_bucket_posture" },
  { toolName: "get_ses_configuration_status", docsAnchor: "24-get_ses_configuration_status" },
  { toolName: "get_sns_topic_status", docsAnchor: "25-get_sns_topic_status" },
  { toolName: "get_eventbridge_rules_status", docsAnchor: "26-get_eventbridge_rules_status" },
  { toolName: "get_budget_status", docsAnchor: "27-get_budget_status" },
