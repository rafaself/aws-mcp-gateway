...
const violations = runLegacySymbolChecks(sourcePaths, readSourceFile);

if (violations.length > 0) {
  console.error("Legacy symbol violations found:\n");
...
console.log("No legacy symbol violations found.");
